...
import '../Style/LoginRegisterFormStyle.css'; // Ensure this CSS is imported
import '../Style/App.css'
import '../Style/Header.css'
function LoginRegisterForm({popupHeading,closeIconPopup}) {
  ...
  return (
    ...
    <div className="login-register-popup">
      <button className='popup-close-icon' onClick={()=>closeIconPopup()}>X</button>
      <h2>{popupHeading}</h2>
